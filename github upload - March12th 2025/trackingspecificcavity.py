...
def CavityTrack():
    ...
    while runBool == 'y':
        ...
        elif endPosZaber < 0 and startPosZaber > 0 and startPosZaber <= 40:
            endPosZaber = 0 
            endPosZaber=round(endPosZaber*20997.375)
            runBool = 'n'
            print('This is your last scan, you are at 0 mm.')

        elif startPosZaber < 0 or startPosZaber > 40:
            print('Integer error somewhere or at 40 mm.')
            break
        ...
        DF1 = pd.DataFrame({'Center Frequency': placeholder, 'Cavity Position (mm):': [maxPos], 'Intensity (V)': [maxIntensity]})
        if i == 0:
        ...
        if runBool == 'n':
            print(f"Experiment concluded. You will find your data in .csv file: ", f'{directory}.csv')
