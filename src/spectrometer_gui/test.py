...
def main():
    ...
    # Test frequency scan
    def frequencyScan():
        spectrometer.scan_frequency(11000, 11200, 0.5)
    ...
    def cavitySearchAndFrequencyScan():
        ...
        # Cavity search
        spectrometer.__oscilloscope_controller.recall_setup(<folder>, <file>)
        ...
        spectrometer.set_output_options(<folder_name>, <filename>)
        spectrometer.set_experiment_settings(<trig_rate>, <acq_rate>, <gate_pos>, <intensity>, <awg_freq>)
        spetrometer.scan_frequency(<start_freq>, <stop_freq>, <step_size>)
